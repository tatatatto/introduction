...
Img.src = "https://github.com/tatatatto/introduction/blob/master/mirror.png"
...
function desuwa(){
    ...
    Img.src = "https://github.com/tatatatto/introduction/blob/master/hime_takabisya_laugh.png";
    return result;
}
function husigi(){
    ...
    Img.src = "https://github.com/tatatatto/introduction/blob/master/yumekawa_girl.png"
    return result;
}
function gowasu(){
    const name = AnameId.value + BnameId.value;
    ...
    Img.src = "https://github.com/tatatatto/introduction/blob/master/sumo_rikishi_harite2.png";
    return result;
}
function daze(){
    const name = AnameId.value + BnameId.value;
    ...
    Img.src = "https://github.com/tatatatto/introduction/blob/master/mild_yankee_dqn.png";
    return result;
}
function desumasu(){ 
    const name = AnameId.value + BnameId.value;
    ...
    if(aaa){
    Img.src = "https://github.com/tatatatto/introduction/blob/master/seibetsu_woman_man.png";
    return result;}
    Img.src = "https://github.com/tatatatto/introduction/blob/master/seibetsu_woman_man_child.png";
    return result;
}

...
Img.src = "./draw/default/mirror.png"
...
function desuwa(){
    ...
    Img.src = "./draw/default/hime_takabisya_laugh.png";
    return result;
}
function husigi(){
    ...
    Img.src = "./draw/default/yumekawa_girl.png"
    return result;
}
function gowasu(){
    const name = AnameId.value + BnameId.value;
    ...
    Img.src = "./draw/default/sumo_rikishi_harite2.png";
    return result;
}
function daze(){
    const name = AnameId.value + BnameId.value;
    ...
    Img.src = "./draw/default/mild_yankee_dqn.png";
    return result;
}
function desumasu(){ 
    const name = AnameId.value + BnameId.value;
    ...
    if(aaa){
    Img.src = "./draw/default/seibetsu_woman_man.png";
    return result;}
    Img.src = "./draw/default/seibetsu_woman_man_child.png";
    return result;
}
